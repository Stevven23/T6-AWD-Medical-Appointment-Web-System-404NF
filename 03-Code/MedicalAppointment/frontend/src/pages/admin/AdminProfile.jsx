      ...
      <div className="space-y-6 max-w-4xl">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Configuración de cuenta y seguridad</p>
          </div>
        </div>
          ...
          <div className="p-6 bg-gradient-to-r from-primary-500 to-primary-600">
            <div className="flex items-center gap-4">
              ...
              <div className="text-white">
                ...
                <p className="text-primary-100">{adminData?.email}</p>
                <span className="inline-flex items-center gap-1 mt-1 px-2 py-1 bg-white/20 rounded text-sm">
                  <ShieldCheckIcon className="w-4 h-4" />
                  {adminData?.administrator?.is_super_admin ? 'Super Administrador' : 'Administrador'}
                </span>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-800">{formatDate(adminData?.created_at)}</p>
                  </div>
                </div>
                <button
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-gray-500">Última actualización: {formatDate(adminData?.password_changed_at) || 'Nunca'}</p>
              </div>
              <button
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                <p className="font-medium text-gray-800">Cerrar Todas las Sesiones</p>
