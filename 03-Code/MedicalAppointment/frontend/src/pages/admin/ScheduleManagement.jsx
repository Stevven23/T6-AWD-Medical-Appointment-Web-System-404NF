    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h2 className="text-2xl font-bold text-gray-800">Horarios y Excepciones</h2>
            <p className="text-gray-600">Gestión de horarios de doctores y solicitudes de cambios</p>
          </div>
                                      ...
                                      <>
                                        ...
                                        {schedule.break_start_time && (
                                          <div className="text-xs text-gray-500">
                                            Descanso: {formatTime(schedule.break_start_time)}
                                          </div>
                                        )}
                                      </>
                                    ) : (
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="space-y-4">
                  {DAYS.map((day, index) => {
                    ...
                    return (
                      <div key={day.id} className={`p-4 rounded-lg border ${schedule.is_working_day ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200'}`}>
